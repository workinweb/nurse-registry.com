...
interface ServiceAgreementTemplateProps {
    name?: string;
    email?: string;
    phone?: string;
    message?: string;
...
export const ServiceAgreementTemplate: React.FC<
    Readonly<ServiceAgreementTemplateProps>
    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    A new service agreement application has been submitted.
                    Please find the attached PDF document containing the
                    application details.
                </p>
            </div>
        </div>
